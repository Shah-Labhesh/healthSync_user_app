                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: recordPdf != null && selectedRecordType == 'PDF'
                          ...
                          : selectedRecordType == 'PDF' && record!.recordType == selectedRecordType?
                          InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                              ...
                              child: Stack(
                                ...
                                children: [
                                  if (recordImage != null &&
                                    ...
                                    if (record!.recordType == "IMAGE" && selectedRecordType == 'IMAGE')
                                    Image.network(
                ...
                children: [
                  ...
                  CustomButtom(
                      ...
                      onPressed: () async {
                        ...
                        if (selectedRecordType == 'PDF' && recordPdf == null && record!.record == null) {
                          Utils.showSnackBar(
                        ...
                        if (selectedRecordType == 'IMAGE' &&
                            recordImage == null && record!.record == null) {
                          Utils.showSnackBar(
                        ...
                        if (selectedMedicalRecordType.isNotEmpty) {
                          newRecord['medicalRecordType'] = selectedMedicalRecordType;
                        }
                         if (selectedRecordType == 'PDF' && recordPdf != null) {
                          newRecord['record'] = await MultipartFile.fromFile(
                              recordPdf!.path,
                              filename: recordPdf!.path.split('/').last,
                              contentType: MediaType('application', 'pdf'));
                        }else if (recordImage != null && selectedRecordType == 'IMAGE') {
                          newRecord['record'] = await MultipartFile.fromFile(
                              recordImage!.path,
                        ...
                        newRecord['recordType'] = selectedRecordType.toUpperCase();
                        
                        if (Utils.checkInternetConnection(context)) {
                          context
                              .read<RecordBloc>()
                              .add(UpdateRecord(record: newRecord, recordId: record!.id!));
                        }
                      }),
                ],
              ),
