              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RowTextWidget(
                      title: 'Doctor',
                      value: 'Dr. ${bookAppointmentModel!.doctor!.name!} - ${bookAppointmentModel!.doctor!.speciality ?? ''}',
                    ),
                    RowTextWidget(
                      title: 'Type',
                      value: bookAppointmentModel!.appointmentType!.removeUnderScore(),
                    ),
                    RowTextWidget(
                      title: 'Time',
                      value: '${bookAppointmentModel!.slotDateTime!.splitDate()} ${bookAppointmentModel!.slotDateTime!.splitTime()}',
                    ),
                    RowTextWidget(
                      title: 'Note',
      ...
      bottomNavigationBar: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomButtom(title: 'Book Appointment', onPressed: () {
