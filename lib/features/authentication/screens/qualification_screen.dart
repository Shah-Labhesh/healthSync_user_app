  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<MoreDocDetailsBloc, MoreDocDetailsState>(
      listener: (context, state) {
        ...
        if (state is AddDocQualificationFailure) {
        ...
        if (state is EditDocQualificationSuccess) {
          Navigator.pop(context, true);
        }
        if (state is EditDocQualificationFailure) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(state.message),
            ),
                          ...
                          if (args != null && args['qualification'] != null) {
                            context.read<MoreDocDetailsBloc>().add(
                                  EditDocQualificationEvent(
                                    ...
                                    qualificationId: args['qualification']
                                        ['qualificationId'],
